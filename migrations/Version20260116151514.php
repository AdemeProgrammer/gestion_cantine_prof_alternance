...
final class Version20260116151514 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Mise à jour des triggers pour supprimer les références à montant_restant (calcul dynamique)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Trigger 1: AFTER INSERT ON description => seed repas + seed facturation
        $this->addSql(<<<'SQL'
...
SQL);
        ...
        // Trigger 2: AFTER INSERT ON repas => MAJ facturation
        $this->addSql(<<<'SQL'
...
SQL);
        ...
        // Trigger 3: AFTER DELETE ON repas => MAJ facturation
        $this->addSql(<<<'SQL'
...
SQL);
        ...
        // Trigger 4: AFTER INSERT ON paiement => répartition du paiement
        $this->addSql(<<<'SQL'
...
SQL);
    ...
    {
        // Restauration des anciens triggers avec montant_restant
        $this->addSql("DROP TRIGGER IF EXISTS trg_paiement_after_insert");
        $this->addSql("DROP TRIGGER IF EXISTS trg_fact_after_insert_repas");
        $this->addSql("DROP TRIGGER IF EXISTS trg_fact_after_delete_repas");
        $this->addSql("DROP TRIGGER IF EXISTS trg_repas_on_description_insert");

        // Note: La restauration complète nécessiterait de recréer les anciens triggers
        // avec montant_restant, ce qui n'est plus possible après la suppression de la colonne
    }
}
